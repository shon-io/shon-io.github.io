---
title: Your Terraform Is Software. Treat It Like Software.
author: Shon Frazier
date: 10 Jan 2025
...
The most common failure mode: no automated tests. Teams write Terraform or Pulumi, get it working, check it in, and never test it. Modules get copied between repos without review. Configuration drift is addressed with manual console edits that never make it back to source. Then staging validation gets skipped entirely.

Your application code requires a PR review, but your infrastructure code just gets merged? You've identified your next production incident.
